...
RELEASES: tuple[Release, ...] = (
    ...
    Release("0.27.0", "2026-09-06", (
        "融合技能包写入软件本体：Impeccable/React Bits/Taste、中文去 AI 味、"
        "女娲蒸馏、Karpathy 工艺、论文脊柱、通宵研究等 18 条，对话按主题注入；"
        "技能库分页展示融合 / 视频 / 本地",
    )),
    Release("0.28.0", "2026-09-06", (
        "工作室模型自动识别工作内容：按任务和项目文件启用匹配技能，"
        "并可用 use_skill 独立调用全部技能与知识库/视频运营插件，无需手动点选",
    )),
    Release("0.29.0", "2026-09-06", (
        "融合 Anime.js v4（juliangarnier/anime）：时间线、交错、SVG 描边/路径，"
        "对话提到动画时自动启用",
    )),
    Release("0.30.0", "2026-09-06", (
